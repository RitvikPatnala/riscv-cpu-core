module control (
    ...
    output logic writeback_mux_select, 
    output logic pc_mux_select
    ...
    always_comb begin
       ...
       reg_write_en = 0; mem_write_en = 0; alu_src_mux_select = 0; writeback_mux_select = 0, pc_mux_select = 0;
       alu_select = 4'b0;
       ...
       case (opcode)
        ...
        B_TYPE: begin // Branch Instructions -- pc_mux_select, alu_select, alu_src_mux_select
            ...
            case (funct3)
                ...
                default: begin
                    pc_mux_select = 0; alu_select = 4'b0;
                end
            endcase
        end
       endcase
